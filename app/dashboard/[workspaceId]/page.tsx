    ...
    <div className="space-y-4 animate-in fade-in zoom-in-95 duration-500 w-full">
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-b from-indigo-500/10 to-purple-500/5 p-5 border border-white/5 shadow-xl">
        ...
        <div className="relative z-10 space-y-1.5">
          <h2 className="text-2xl font-semibold tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-white to-white/80">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="bg-white/5 border-white/10 backdrop-blur-xl hover:bg-white/10 transition-colors shadow-md group">
          ...
          <CardContent className="px-4 pb-4">
            <div className="text-2xl font-semibold tracking-tighter text-white">{docCount}</div>
        ...
        <Card className="bg-white/5 border-white/10 backdrop-blur-xl hover:bg-white/10 transition-colors shadow-md group">
          ...
          <CardContent className="px-4 pb-4">
            <div className="text-2xl font-semibold tracking-tighter text-white">{convCount}</div>
            <p className="text-[11px] text-muted-foreground mt-0.5">
              Total AI chats
            </p>
          </CardContent>
        ...
        <Card className="bg-white/5 border-white/10 backdrop-blur-xl hover:bg-white/10 transition-colors shadow-md group">
          ...
          <CardContent className="px-4 pb-4">
            <div className="text-2xl font-semibold tracking-tighter text-white">{taskCount}</div>
            <p className="text-[11px] text-muted-foreground mt-0.5">
